...
import { ProjectDto, PROJECTS_CONTROLLER, PROJECTS_ROUTES } from '@app/contract';
...
export class ProjectsController {
  ...
  @ApiCreatedResponse({ type: ProjectDto, description: "Return created project" })
  ...
  update(@Project() project: ProjectEntity,
  ...
  remove(@Project() project: ProjectEntity,
         @User() user: UserEntity
  ) {
